...
public class StudentManage_02 {
		...
		private ArrayList<Student_02> students = new ArrayList<>();
...
//		static String[] className = {"JAVA", "PYTHON", "C", "JS"};
		...
		public Student_02 findStudentInform(int studentNumber) {
		...
		public ArrayList<Student_02> getStudents() {
			return students;
		}
		...
		public void setStudents(ArrayList<Student_02> students) {
...
//			int studentNumber = input.nextInt();	// 학번 입력 받기
			...
			Student_02 newStudent = findStudentInform(studentNumber);
			if (newStudent == null) { // 새로운 학생이 null 이면 학번까지 입력하고 저장
				newStudent = new Student_02(studentNumber);
...
//			int studentNumber = input.nextInt();	// 학번을 입력 받음
		...
		public void setClass(String message, Student_02 newStudent, boolean check) {
...
//				}
		...
		private void printStudent(Student_02 student) { // 정보조회 출력 메소드
			System.out.println("학번: " + student.getStudentNumber());
			System.out.println("이름: " + student.getName());
			System.out.println("전화번호: " + student.getPhoneNumber());
			System.out.println("메모: " + student.getMemo());
